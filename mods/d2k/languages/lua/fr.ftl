...
objective-completed = Objectif réussi

primary = Primaire
secondary = Secondaire

new-primary-objective = Nouvel objectif primaire
new-secondary-objective = Nouvel objectif secondaire

mentat = Mentat

## atreides-01ab, atreides03ab, harkonnen-01a, ordos-05
harvested-resources = Ressources récoltées: { $harvested }/{ $goal }
harvest-spice = Récoltez ne valeur de { $spice } Solaris d'Épice.
not-enough-silos = Nous n'avons pas assez d'espace de silo pour stocker la quantité requise d'épice!

## atreides-01ab, harkonnen-01ab, ordos01ab
build-concrete = Construit une Fondation en Béton avant d'y placer vos batiments.
build-windtrap = Construit un Piège à Vent.
build-refinery = Construit une Raffinerie pour collecter l'Épice.
build-silo = Construit un Silo pour stocker l'Épice additionnel.

## atreides-01ab, ordos01a, ordos-03ab
eliminate-harkonnen-units-reinforcements = Éliminer toute les unités et renforcement Harkonnen 
dans la Zone

## atreides-02a, atreides-04, atreides-05, ordos-02ab, ordos-03ab, ordos-04, ordos-06a
harkonnen-annihilated = Les Harkonnen ont été anéanti!

## atreides-02a, ordos02ab
destroy-harkonnen-forces = Détruisez toute les forces Harkonnen.

## atreides-02b, atreides-03b, harkonnen-05, harkonnen-06ab, harkonnen-08
ordos-annihilated = Les Ordos ont été anéanti!
